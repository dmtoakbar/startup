...
@section('body-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Content Names
                <small>Edit Content Name</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Content Names</a></li>
                <li class="active">Edit Content Name</li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <form action="{{ route('office-site-home-page-content-name-edit', $content->id) }}" role="form" method="POST">
                                    @csrf
                                    <div class="box-body">
