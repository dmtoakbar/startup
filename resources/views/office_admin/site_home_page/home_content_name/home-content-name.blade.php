...
@section('body-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Content Names
                <small>Content Names table</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Content Names</a></li>
                <li class="active">Content Names table</li>
            </ol>
        </section>
      {{-- delete model --}}
        <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="{{route('office-site-home-page-content-name-delete')}}" method="POST">
                    @csrf
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header text-right">
                            <h3 class="box-title"><a href="{{ route('office-site-home-page-content-name-add') }}" class="btn btn-primary"
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td class="d-block text-center">
                                      <a href="{{route('office-site-home-page-content-name-edit', $item->id)}}" class="btn btn-success">Edit</a>
