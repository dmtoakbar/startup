...
@section('body-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Subjects
                <small>Subjects table</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Subjects</a></li>
                <li class="active">Subjects table</li>
            </ol>
        </section>
      {{-- delete model --}}
        <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="{{route('office-subjects-delete')}}" method="POST">
                    @csrf
           ...
           <div class="modal fade" id="StatusModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="{{route('office-subjects-status')}}" method="POST">
                    @csrf
                <div class="modal-body">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header text-right">
                            <h3 class="box-title"><a href="{{ route('office-subjects-add') }}" class="btn btn-primary"
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td class="d-block text-center">
                                      <a href="{{route('office-subjects-edit', $item->id)}}" class="btn btn-success">Edit</a>
