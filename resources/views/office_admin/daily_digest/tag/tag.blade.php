        ...
        <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="{{route('office-tag-delete')}}" method="POST">
                    @csrf
                    @method('DELETE')
           ...
           <div class="modal fade" id="StatusModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="{{route('office-tag-status')}}" method="POST">
                    @csrf
                <div class="modal-body">
           ...
           <div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="{{route('office-digest-tag-add-and-edit')}}" method="POST">
                    @csrf
                    @method('POST')
                <div class="modal-body">
                  <div class="form-group">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form action="{{route('office-digest-tag-add-and-edit')}}" method="POST">
                  <?php 
                  if(isset($_GET['edit'])) {
                    $update = DB::table('tags')->where('id', trim($_GET['edit']))->first();
                    if($update != null) {
                      ?>
                      @csrf
                      @method('PUT')
