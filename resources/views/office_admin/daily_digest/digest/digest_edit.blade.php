...
@section('body-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Digest Content
                <small>Edit Digest Content</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Digest Content</a></li>
                <li class="active">Edit Digest Content</li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <form action="{{ route('office-digest-content-edit') }}" role="form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="box-body">
                                        <input type="hidden" name="id" value="{{$data->id}}">
                                        <div class="form-group">
                                            <label for="">Title<span>*</span></label>
                                            <input type="text" name="title" value="{{$data->title}}" class="form-control" placeholder="Enter content title" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    ...
                                                    if(!empty($data->feature_img)) {
                                                        ?>
                                                        <img src="/image/digest_content/{{$data->feature_img}}" id="preImage" height="100">
                                                        <?php
                                                    }
                                                    ?>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="addSubTag">
                                                    ...
                                                    <?php
                                                     if(!empty($data->subtag_id)) {
                                                        $subTag = \App\Models\Subtag::where('tag_id', $data->tag->id)->get();
                                                      ?>
                                                      <div class="form-group">
                                                        <label for="">Sub Tag</label>
                                                        <select name="sub_tag" class="form-control">
                                                            <option value="{{$data->subtag->id}}">{{$data->subtag->name}}</option>
                                                            @foreach ($subTag as $sub)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="digestConent" name="content" required>{{$data->content}}</textarea>
                                        </div>
                                        <small class="text-danger">
                                            @error('content')
                                                {{ $message }}
