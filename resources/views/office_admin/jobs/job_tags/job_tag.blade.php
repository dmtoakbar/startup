...
@section('body-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Tags
                <small>Tags table</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Tags</a></li>
                <li class="active">Tags table</li>
            </ol>
        </section>
      {{-- delete model --}}
        <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="{{route('office-job-tag-delete')}}" method="POST">
                    @csrf
                    @method('DELETE')
           ...
           <div class="modal fade" id="StatusModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="{{route('office-job-tag-status')}}" method="POST">
                    @csrf
                <div class="modal-body">
           ...
           <div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="{{route('office-job-tag-add-and-edit')}}" method="POST">
                    @csrf
                    @method('POST')
                <div class="modal-body">
                  <div class="form-group">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form action="{{route('office-job-tag-add-and-edit')}}" method="POST">
                  <?php 
                  if(isset($_GET['edit'])) {
                    $update = DB::table('jobtags')->where('id', trim($_GET['edit']))->first();
                    if($update != null) {
                      ?>
                      @csrf
                      @method('PUT')
                      <div class="modal-body">
                        <input type="hidden" name="id" value="{{$update->id}}" id="">
                        <div class="form-group">
                          <label for="tag">Tag name:</label>
                           <input type="text" name="name" class="form-control" value="{{$update->name}}" placeholder="Enter tag name" required>
                       </div>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
