...
@section('body-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Job Content
                <small>Copy Job Content</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Job Content</a></li>
                <li class="active">Copy Job Content</li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <form action="{{ route('office-job-content-copy') }}" role="form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="box-body">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="tag" id="tagItems" class="form-control" required>
                                                        <option value="" selected disabled>Choose a job tag</option>
