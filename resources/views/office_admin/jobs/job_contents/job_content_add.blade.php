...
@section('body-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Job Content
                <small>Add Job Content</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Job Content</a></li>
                <li class="active">Add Job Content</li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <form action="{{ route('office-job-content-add') }}" role="form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" value="{{old('title')}}" placeholder="Enter content title" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="jobDescriptionIntro" name="orgnisation_intro" required>{{old('orgnisation_intro')}}</textarea>
                                                    <small class="text-danger">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="dateAndFee" name="important_dates" required>{{old('important_dates')}}</textarea>
                                                    <small class="text-danger">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="jobDescription" name="description" required>{{old('description')}}</textarea>
                                                    <small class="text-danger">
                                                        @error('description')
                                                            {{ $message }}
                                                        @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="dateAndFee" name="fee_structure" required>{{old('fee_structure')}}</textarea>
                                                    <small class="text-danger">
                                                        @error('fee_structure')
                                                            {{ $message }}
                                                        @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="dateAndFee" name="basic_qualifaction" required>{{old('basic_qualifaction')}}</textarea>
                                            <small class="text-danger">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="jobDetail" name="detail_first" required>{{old('detail_first')}}</textarea>
                                            <span class="btn btn-sm btn-primary" id="detailFirst">Add more +</span>
                                        </div>
                                        <small class="text-danger">
                                            @error('detail_first')
                                                {{ $message }}
                                        ...
                                        <div id="hideDetailSecond" style="display: none;">
                                            <p class="text-center" style="color: white; font-size: 16px; font-weight: bold; width: 100%; background-color: blue;">Job Detail</p>
                                            <div class="form-group">
                                                <label>Job Detail</label>
                                                <textarea class="jobDetail" name="detail_second"></textarea>
                                                <div class="d-flex justify-content-between" style="display: flex; justify-content: space-between;">
                                                    <span class="btn btn-sm btn-primary" id="detailSecond" >Add more +</span>
                                                    <span class="btn btn-sm btn-danger float-left" id="detailSecondRemove">Remove</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="hideDetailThird" style="display: none;">
                                            <p class="text-center" style="color: white; font-size: 16px; font-weight: bold; width: 100%; background-color: blue;">Job Detail</p>
                                            <div class="form-group">
                                                <label>Job Detail</label>
                                                <textarea class="jobDetail" name="detail_third"></textarea>
                                                <div class="d-flex justify-content-between" style="display: flex; justify-content: space-between;">
                                        ...
                                        <div class="row importantLink_1 countLink">
                                            <div class="col-md-4">
                                             <div class="form-group">
                                                <label for="">Title For Link</label>
                                             <input type="text" name="link_title[]" class="form-control" placeholder="Enter title for link" required>
                                             </div>
                                            </div>
                                            <div class="col-md-4">
                                             <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="">Link (URL)</label><span class="pull-right" id='importantLink_1' style="font-size: 20px; height: 20px; font-weight: bolder; color: rgb(235, 8, 8); cursor: pointer; ">×</span>
